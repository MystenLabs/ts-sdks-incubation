...
export interface AppPackages {
	readonly "vault": { readonly id: string; readonly objects?: Record<string, string> };
}
...
export interface AppNetworkDeployment
	...
	readonly values: {
		...
		"walrus": {
			...
			"nodes": ReadonlyArray<{ readonly nodeIndex: number; readonly publicHostname: string; readonly rpcUrl: string }>;
