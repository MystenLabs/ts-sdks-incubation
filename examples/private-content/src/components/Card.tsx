...
// FRICTION: third copy. See examples/wallet/src/components/Card.tsx +
// examples/token-studio/src/components/Card.tsx. Three copies = real extract
// trigger, but holding for the planned `@mysten-incubation/ui` package in M5.
