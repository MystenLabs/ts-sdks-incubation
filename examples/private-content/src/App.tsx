...
export function App() {
	const deployed = useDevstackDeployed({ requirePackages: ['vault'] });
	return (
		<div className="min-h-screen flex flex-col">
				...
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<p className="text-xs text-neutral-500 leading-tight">
							Sui dev-examples · Seal + capabilities · localnet
						</p>
					</div>
				</div>
				<ConnectButton />
			...
			<footer className="px-6 py-3 border-t border-neutral-200 dark:border-neutral-800 text-xs text-neutral-500">
				Phase 4 · capability-gated decryption demo
			</footer>
		</div>
	);
}
	...
	return (
		<div className="rounded-xl border border-dashed border-neutral-300 dark:border-neutral-700 px-5 py-6 text-center">
			<p className="text-sm text-neutral-600 dark:text-neutral-300">
				Click <strong>Connect Wallet</strong> in the top-right and pick the{' '}
