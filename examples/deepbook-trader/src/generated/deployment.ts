...
export interface AppPackages {
	readonly "deepbook": { readonly id: string; readonly objects?: Record<string, string> };
	readonly "demo_coins": { readonly id: string; readonly objects?: Record<string, string> };
	readonly "dusdc": { readonly id: string; readonly objects?: Record<string, string> };
	readonly "pyth": { readonly id: string; readonly objects?: Record<string, string> };
}
