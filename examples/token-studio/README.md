...
mint, burn, and transfer flows gated by the cap.
...
├── e2e/                  # Playwright: mint, burn, transfer flow
└── src/                  # React UI: cap-gated mint/burn/transfer
```
...
pnpm test:e2e     # Playwright: mint → burn → transfer
```
