// seal-mini — smallest seal-using devstack example.
//
// Stand-in target for the (not-yet-ported) `private-content`
...
const stack: Stack<ReadonlyArray<AnyMember>> = defineDevstack(sui(), admin, sealPlugin, {
	stackName: 'seal-mini',
});
