...
description: useDevWallet hook, DevWalletProvider context, and React-wrapped Lit components
---

The dev wallet provides React hooks, a context provider, and React-wrapped Lit components.
...
function App() {
	return (
		<DAppKitProvider dAppKit={dAppKit}>
			...
			<main>{/* Your app content — the dev wallet appears in the wallet picker */}</main>
		</DAppKitProvider>
	);
}
```
