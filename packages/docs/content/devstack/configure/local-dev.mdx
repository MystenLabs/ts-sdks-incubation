...
`http://dev.<stack>.<app>.localhost:5175`. See [Dev servers](/devstack/configure/dev-server) for
ports and routing, and [Refs and dependencies](/devstack/reference/internals/refs-and-tags) for how
