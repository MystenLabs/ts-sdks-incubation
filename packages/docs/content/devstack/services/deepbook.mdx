...
`poolId` and coin types from the bindings, and sign them with your wallet / dapp-kit. See
[`examples/deepbook-trader`](https://github.com/MystenLabs/ts-sdks-incubation/tree/main/examples/deepbook-trader)
for a complete trading UI — multiple pools, multiple feeds, and swap execution.
