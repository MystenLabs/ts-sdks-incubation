...
[Dev servers](/devstack/features/services/dev-server#port-assignment-and-routing) for the port
assignment details.
...
local-mode service. See [Walrus](/devstack/features/services/walrus).
...
local-mode service. See [Seal](/devstack/features/services/seal).
...
prices that the stack created. See [DeepBook](/devstack/features/services/deepbook).
...
See [Known packages](/devstack/features/services/known-packages).
