// Playwright integration for devstack-effect. Playwright drives the
...
//   import { setupDevstack } from '@mysten-incubation/devstack-effect/playwright';
...
export const setupDevstack = (devstack: Devstack): DevstackPlaywrightFixture => {
	...
	return {
		globalSetup: async () => {
			if (scope !== undefined) {
				throw new Error('[devstack-effect/playwright] globalSetup called twice');
			}
