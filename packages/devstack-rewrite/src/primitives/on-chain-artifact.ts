// OnChainArtifactPublisher — L0 substrate primitive (architecture §10).
//
...
/** Input contract for OnChainArtifactPublisher.publish. */
export interface OnChainArtifactSpec<Produced, Verified> {
	...
	readonly produce: Effect.Effect<Produced, OnChainArtifactError, Scope.Scope>;
...
export interface OnChainArtifactError {
	readonly _tag: 'OnChainArtifactError';
...
export interface OnChainArtifactPublisher {
