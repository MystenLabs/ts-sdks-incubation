...
- Do not commit `packages/devstack-rewrite/{dist,.turbo,node_modules}`,
  `packages/devstack-rewrite/src/generated/`, runtime wallet token state, example `dist/.turbo`
...
- Regenerate the lockfile after cleanup. It currently contains a stale generated importer for
  `packages/devstack-rewrite/test/e2e/fixtures/seal-stub/build/seal_stub/debug_info/dependencies/Sui`.
- Exclude unrelated dev-wallet/changeset/old-example dirty files from rewrite checkpoints unless the
...
8. Docs/examples cleanup so public material matches the rewrite API and current behavior.
...
area, and a final full build/test pass before calling the rewrite ready for cutover.
...
Primary objective: finish `packages/devstack-rewrite` to release-quality standards, not merely make
...
- `/Users/michaelhayes/code/ts-sdks-incubation/packages/devstack-rewrite/README.md`
- `/Users/michaelhayes/code/ts-sdks-incubation/packages/devstack-rewrite/notes/README.md`
- `/Users/michaelhayes/code/ts-sdks-incubation/packages/devstack-rewrite/notes/CURRENT-HANDOFF.md`
- `/Users/michaelhayes/code/ts-sdks-incubation/packages/devstack-rewrite/notes/UNRESOLVED-BLOCKERS.md`
- `/Users/michaelhayes/code/ts-sdks-incubation/packages/devstack-rewrite/STYLE_GUIDE.md`
- `/Users/michaelhayes/code/ts-sdks-incubation/packages/devstack-rewrite/ARCHITECTURE.md`
