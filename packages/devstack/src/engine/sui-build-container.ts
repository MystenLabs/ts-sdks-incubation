...
import { defaultMoveHome } from './move-build-lock.js';
...
// Move-build lock + stale-git-lock sweep live in `engine/move-build-lock.ts`
// (audit finding E51) so `engine/sui-cli.ts` and the CLI commands can
// reach them without depending on this module's SuiBuildContainer service.
