...
export interface ManifestOptions {
	...
	endpoints?: Array<Dep<Endpoint> | Dep<Endpoint[]>>;
	/** Accounts (signer addresses keyed by logical name). */
	accounts?: Dep<Account>[];
	...
	extras?: Record<string, Dep<unknown>>;
}
...
// only show when actual content changes. The `Manifest` type lives in
// `@mysten-incubation/devstack/shapes` so the generated file imports
// rather than redeclares it — keeps shape changes in one place.
export function renderManifest(deps: ManifestDeps): string {
	...
	return `// AUTO-GENERATED by @mysten-incubation/devstack manifest — do not edit.
// Re-emitted whenever any upstream package / endpoint / account / coin / extra changes.

import type { Manifest } from '@mysten-incubation/devstack/shapes';
