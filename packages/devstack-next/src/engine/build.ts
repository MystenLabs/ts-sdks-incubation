...
function flattenDeps(deps: unknown): Dep<any, any>[] {
	const out: Dep<any, any>[] = [];
	collect(deps, out, new Set());
	return out;
}

function collect(value: unknown, out: Dep<any, any>[], seen: Set<unknown>): void {
...
function isDep(value: unknown): value is Dep<any, any> {
